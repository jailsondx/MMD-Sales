const AtualizarEstoque = require('./AtualizarEstoque');
    ...
    try {
        ...
        for (const item of itensVenda) {
          ...
          `;
            ...
            // Agora, chamamos a função para atualizar o estoque com base no ID do produto
            // Aqui você precisará passar o id_produto de cada item, caso já tenha esse dado
            await AtualizarEstoque(DBconnection, item.id, item.quantidade);
        }
